...
const Input = (props: InputProps) => {
    ...
    return <div style={style} onClick={() => document.getElementById(randomId)?.focus()}
        ...
        <textarea rows={rows ?? 1} id={randomId} {...rest} value={valueState[0]}
                  ...
                  className={cn("resize-none z-5 w-full h-full bg-transparent py-1 px-2 text-xl font-bold focus:outline-none md:py-2 md:px-4 md:text-3xl", fullWidth && "w-full", innerClassName)}
        />
    </div>
